...
document.querySelector(".details-the-flash").addEventListener("click", function(){
    document.querySelector(".container").classList.toggle("show-menu-the-flash");
})

document.querySelector(".close-the-flash").addEventListener("click", function(){
    document.querySelector(".container").classList.toggle("show-menu-the-flash");
})

document.querySelector(".details-arrow").addEventListener("click", function(){
    document.querySelector(".container").classList.toggle("show-menu-arrow");
})
